...
// narrow_gauge is here for Stockholm: Roslagsbanan is an 891 mm network, a
// third of the lokalbanor mileage, and OSM tags it railway=narrow_gauge — with
// it missing from this set the ways passed the cfg filter and were still
// dropped when the graph was built, so lines 27, 28 and 29 came out empty.
const RAIL_OK = new Set(['subway', 'tram', 'light_rail', 'rail', 'narrow_gauge']);
